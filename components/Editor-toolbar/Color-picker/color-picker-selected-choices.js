...
const ColorPickerChoices = (props) => {
	...
	let arrayOfPaths = [
		<path
			...
			fill={props.onChangeColor ? props.onChangeColor : "white"}
		/>,
		<path
			d={getSectorPath(
				outerDiameter / 2,
...
export default ColorPickerChoices;
