...
const Projects = () => {
	return (
		<MyProjects id="project-section">
			...
			sit amet..", comes from a line in section 1.10.32. Lorem Ipsum is simply
			...
			line in section 1.10.32. Lorem Ipsum is simply dummy text of the printing
